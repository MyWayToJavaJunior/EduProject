...
public class UserConvertTest {
    ...
    public void whenListThenHashMap() {
        ...
        list.add(new User(1, "firstName", "firstCity"));
        list.add(new User(2, "secondName", "secondCity"));
        HashMap<Integer, User> testData = new HashMap<>();
        testData.put(1, new User(1, "firstName", "firstCity"));
        testData.put(2, new User(2, "secondName", "secondCity"));
